...
try {
  ...
  execSync('npx typedoc --tsconfig tsconfig.docs.json --out docs --name "X API SDK v0.2.2-beta" --readme README.md --theme default --includeVersion true --excludePrivate true --excludeProtected true --excludeExternals true --excludeInternal true --searchInComments true --cleanOutputDir true', { stdio: 'inherit' });
