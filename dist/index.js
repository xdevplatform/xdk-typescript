...
var Client = class {
  ...
  constructor(config) {
    ...
    const defaultHeaders = {
      "User-Agent": "xdk-typescript/0.2.2-beta",
      "Content-Type": "application/json",
...
export { models_exports15 as AccountActivity, AccountActivityClient, models_exports9 as Activity, ActivityClient, ApiError, Client, models_exports8 as Communities, CommunitiesClient, models_exports10 as CommunityNotes, CommunityNotesClient, models_exports14 as Compliance, ComplianceClient, models_exports4 as Connections, ConnectionsClient, CryptoUtils, models_exports12 as DirectMessages, DirectMessagesClient, EventPaginator, models_exports17 as General, GeneralClient, HttpClient, models_exports7 as Lists, ListsClient, models_exports5 as Media, MediaClient, models_exports16 as News, NewsClient, OAuth1, OAuth2, Paginator, PostPaginator, models_exports2 as Posts, PostsClient, schemas_exports as Schemas, models_exports3 as Spaces, SpacesClient, models_exports18 as Stream, StreamClient, models_exports6 as Trends, TrendsClient, models_exports13 as Usage, UsageClient, UserPaginator, models_exports11 as Users, UsersClient, models_exports as Webhooks, WebhooksClient, generateCodeChallenge, generateCodeVerifier, generateNonce, generateTimestamp, hmacSha1, httpClient };
