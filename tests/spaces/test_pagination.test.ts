...
describe('SpacesClient Pagination', () => {
  let client: Client;
  ...
  it('should create paginator for getBuyers', () => {
  ...
  it('should paginate through pages for getBuyers', async () => {
    ...
    try {
      ...
      const firstPage = await method.apply(spacesClient, [...requiredArgs, options]);
      ...
      if (firstPage.meta && firstPage.meta['next_token']) {
        ...
        const secondPage = await method.apply(spacesClient, [...requiredArgs, options]);
  ...
  it('should handle pagination parameters correctly for getBuyers', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      await method.apply(spacesClient, [...requiredArgs, options]);
