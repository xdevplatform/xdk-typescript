...
describe('ChatClient Pagination', () => {
  ...
  it('should create paginator for getConversationEvents', () => {
  ...
  it('should paginate through pages for getConversationEvents', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should handle pagination parameters correctly for getConversationEvents', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
