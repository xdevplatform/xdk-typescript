 ...
 * Any manual changes will be overwritten on the next generation.
 * 
 * Auto-generated pagination tests for Chat client.
 *
...
describe('ChatClient Pagination', () => {
  let client: Client;
  ...
  it('should create paginator for getConversation', () => {
  ...
  it('should paginate through pages for getConversation', async () => {
    ...
    try {
      ...
      const firstPage = await method.apply(chatClient, [...requiredArgs, options]);
      ...
      if (firstPage.meta && firstPage.meta['next_token']) {
        ...
        const secondPage = await method.apply(chatClient, [...requiredArgs, options]);
  ...
  it('should handle pagination parameters correctly for getConversation', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      await method.apply(chatClient, [...requiredArgs, options]);
  ...
  it('should create paginator for getConversations', () => {
  ...
  it('should paginate through pages for getConversations', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should handle pagination parameters correctly for getConversations', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
