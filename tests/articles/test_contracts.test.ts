 ...
 * Any manual changes will be overwritten on the next generation.
 * 
 * Auto-generated contract tests for Articles client.
 *
 * This module contains tests that validate the request/response contracts
 * of the Articles client against the OpenAPI specification.
 *
 * Generated automatically - do not edit manually.
 */

import { describe, it, expect, beforeAll, jest } from '@jest/globals';
import { ArticlesClient } from '../../src/articles/client.js';
import { Client } from '../../src/client.js';

describe('ArticlesClient Contracts', () => {
  let client: Client;
  ...
  it('should have correct request structure for articleCreateDraft', async () => {
    ...
    try {
      ...
      // Call the method
      const method = (articlesClient as any)['articleCreateDraft'];
      const result = await method.apply(articlesClient, [...requiredArgs, options]);
      ...
      const expectedPath = '/2/articles/draft';
  ...
  it('should handle required parameters correctly for articleCreateDraft', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      await expect(method.apply(articlesClient, [...requiredArgs, options])).resolves.toBeDefined();
  ...
  it('should validate response structure for articleCreateDraft', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should have correct request structure for articlePublish', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      // Call the method
      const method = (articlesClient as any)['articlePublish'];
      const result = await method.apply(articlesClient, [...requiredArgs, options]);
      ...
      // Check URL structure - path parameters are replaced in the URL
      const expectedPath = '/2/articles/{article_id}/publish';
      // Path parameters are replaced with actual values, so check for the base path structure
      const basePath = expectedPath.split('{')[0];
      expect(url).toContain(basePath);
  ...
  it('should handle required parameters correctly for articlePublish', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should validate response structure for articlePublish', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
