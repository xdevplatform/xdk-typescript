...
describe('ActivityClient Contracts', () => {
  ...
  it('should have correct request structure for deleteSubscriptionsByIds', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      // Call the method
      const method = (activityClient as any)['deleteSubscriptionsByIds'];
      const result = await method.apply(activityClient, [...requiredArgs, options]);
  ...
  it('should handle required parameters correctly for deleteSubscriptionsByIds', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should validate response structure for deleteSubscriptionsByIds', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
