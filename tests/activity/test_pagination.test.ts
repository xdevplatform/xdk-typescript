 ...
 * Any manual changes will be overwritten on the next generation.
 * 
 * Auto-generated pagination tests for Activity client.
 *
...
describe('ActivityClient Pagination', () => {
  let client: Client;
  ...
  it('should create paginator for getSubscriptions', () => {
  ...
  it('should paginate through pages for getSubscriptions', async () => {
    ...
    try {
      ...
      const firstPage = await method.apply(activityClient, [...requiredArgs, options]);
      ...
      if (firstPage.meta && firstPage.meta['next_token']) {
        ...
        const secondPage = await method.apply(activityClient, [...requiredArgs, options]);
  ...
  it('should handle pagination parameters correctly for getSubscriptions', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      await method.apply(activityClient, [...requiredArgs, options]);
