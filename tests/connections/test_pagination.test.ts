 ...
 * Any manual changes will be overwritten on the next generation.
 * 
 * Auto-generated pagination tests for Connections client.
 *
...
describe('ConnectionsClient Pagination', () => {
  let client: Client;
  ...
  it('should create paginator for getConnectionHistory', () => {
  ...
  it('should paginate through pages for getConnectionHistory', async () => {
    ...
    try {
      ...
      const firstPage = await method.apply(connectionsClient, [...requiredArgs, options]);
      ...
      if (firstPage.meta && firstPage.meta['next_token']) {
        ...
        const secondPage = await method.apply(connectionsClient, [...requiredArgs, options]);
  ...
  it('should handle pagination parameters correctly for getConnectionHistory', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      await method.apply(connectionsClient, [...requiredArgs, options]);
